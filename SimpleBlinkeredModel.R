...
# ####################################################################################
SimpleBlinkeredModel = function(x, y, trainset, validset, learning_rate=0.1, blinker=NULL, delta=NULL, tolerance=0.1, epochs=5) {
